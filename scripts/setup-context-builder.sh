...
cat > scripts/build-full-context.sh << 'SCRIPT_EOF'
#!/bin/bash
...
# Make it executable
chmod +x scripts/build-full-context.sh

echo "✓ Script created: scripts/build-full-context.sh"
echo ""
echo "To build full context file, run:"
echo "  ./scripts/build-full-context.sh"
echo ""
echo "This will include:"
echo "  - All files from .claud/"
echo "  - All files from docs/design/"